...
flags.DEFINE_string('annotation_dir', '', 'Path to annotations directory')
flags.DEFINE_string('output_path', '', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', 'kangroo_detect_TF_API/dataset/kangroo_label_map.pbtxt', 'Path to label map proto')
